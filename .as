...
(function () {
    API.on('chat', function(data) { if (data.from+"" == API.getUser().username) $('.chat-id-' + data['chatID']).attr('style','background-image:url(https://raw.github.com/Maxorq/LastPlug/c75755255596c8e2f35fc087f6abfc2a6d875adf/img/sparkle.gif);'); })
